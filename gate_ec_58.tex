...
\begin{align}
F(\omega) &= \int_{-\infty}^{\infty} rect\left(\frac{t}{a}\right) e^{-j\omega t} dt \\
&= \int_{-\frac{a}{2}}^{\frac{a}{2}} e^{-j\omega t} dt \\
&= \left. \frac{1}{-i\omega} e^{-j\omega t} \right|_{-\frac{a}{2}}^{\frac{a}{2}} \\
&= \frac{1}{-j\omega} (e^{-j\omega \frac{a}{2}} - e^{j\omega \frac{a}{2}}) \\
